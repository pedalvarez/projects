...
namespace SQLConfigurator
{
    ...
    public class OleDBOracleOracleConnectionProperties : OleDBSpecializedConnectionProperties
    {
        public OleDBOracleOracleConnectionProperties()
            : base("OraOLEDB.Oracle")
        {
            // We always start with integrated security turned on
            this["OLEDB.NET"] = "True";
        }
