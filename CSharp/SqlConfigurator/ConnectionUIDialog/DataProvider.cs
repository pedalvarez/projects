...
#pragma warning restore 618
 descriptions,
        ...
        public static DataProvider OracleOleDBDataProvider
        {
            get
            {
                if (_oracleOleDBDataProvider == null)
                {
                    ...
                    Dictionary<string, Type> properties = new Dictionary<string, Type>();                    
                    properties.Add(DataSource.OracleDataSource.Name, typeof(OleDBOracleOracleConnectionProperties));                    
                    properties.Add(String.Empty, typeof(OleDBConnectionProperties));
                ...
                return _oracleOleDBDataProvider;
            }
        }
        private static DataProvider _oracleOleDBDataProvider;
